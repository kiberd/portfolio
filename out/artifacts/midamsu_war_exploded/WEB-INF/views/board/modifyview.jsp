...
<section class="main clearfix">
    ...
    <div class="container">
        <form onsubmit="return submitCheck()" id="boardForm" action="modify.do" name="boardForm" method="post"
              style="margin-top: 30px"  enctype="multipart/form-data">


            <input type="hidden" name="bId" value="${boardVO.BId}">
            <%--                <input type="hidden" name="bTitle" value="${boardVO.BTitle}">--%>
            <%--                <input type="hidden" name="bContent" value="${boardVO.BContent}">--%>
            <input id="title" type="text" name="bTitle" style="width: 100%" value="${boardVO.BTitle}">
            <textarea id="summernote" name="bContent" >${boardVO.BContent}</textarea>
