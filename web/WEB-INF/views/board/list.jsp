...
<section class="main clearfix">
    ...
    <div class="container">
            ...
            <div class="col-md-12 col-xs-12 text-center">
                <ul class="pagination">
                    ...
                    <c:if test="${pageMaker.criteria.pageNum > 1}">
                        <li class="page-item">
                            <a class="page-link" href="${path}/board/list${pageMaker.makeQuery(pageMaker.startPage)}"
                               aria-label="Previous">
                    ...
                    <c:if test="${pageMaker.criteria.pageNum > 5}">
                        <li class="paginate_button">
                            <a href="${path}/board/list${pageMaker.makeQuery(1)}">1</a>
                        </li>
                    ...
                    <c:forEach var="num" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
                        <li class="paginate_button ${pageMaker.criteria.pageNum == num ? 'active' :''}">
                            <a href="${path}/board/list${pageMaker.makeQuery(num)}">${num}</a>
                        </li>
                    </c:forEach>
                    ...
                    <c:if test="${pageMaker.totalPage - pageMaker.criteria.pageNum > 5}">
                        ...
                        <li class="paginate_button">
                            <a href="${path}/board/list${pageMaker.makeQuery(pageMaker.totalPage)}">${pageMaker.totalPage}</a>
                        </li>
                    </c:if>
                    ...
                    <li class="page-item">
                        <a class="page-link" href="${path}/board/list${pageMaker.makeQuery(pageMaker.endPage)}"
                           aria-label="Next">
        ...
        <div class="row">
            <div>
                <a href="#" onclick="loginCheck('/board/writeview');" class="btn btn-success">글쓰기</a>
            </div>
        </div>
